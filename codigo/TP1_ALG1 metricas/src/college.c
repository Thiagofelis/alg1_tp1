...
college college_createinstance(int _min_grade, int _max_num_of_students)
{
    ...
    new_instance.occupied_places = 0;
    return new_instance;
}
...
int college_addstudent(college* instance, int student_index, int student_grade)
{
    ...
    {
        return studentlist_insert(&(instance->header), student_index, student_grade, instance->max_num_of_students, &(instance->occupied_places));
    }
